...
#ifndef LV_ATTRIBUTE_KEY_7
#define LV_ATTRIBUTE_KEY_7
#endif

static const
LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_KEY_7
uint8_t key_7_map[] = {

    0x00,0x00,0x00,0xfb,0x00,0x00,0x00,0x0b,
