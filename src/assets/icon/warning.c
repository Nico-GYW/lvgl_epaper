...
#ifndef LV_ATTRIBUTE_WARNING
#define LV_ATTRIBUTE_WARNING
#endif

static const
LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_WARNING
uint8_t warning_map[] = {
