...
#ifndef LV_ATTRIBUTE_NEXT
#define LV_ATTRIBUTE_NEXT
#endif

static const
LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_NEXT
uint8_t next_map[] = {

    0x4c,0x70,0x47,0x00,0x00,0x00,0x00,0xec,
