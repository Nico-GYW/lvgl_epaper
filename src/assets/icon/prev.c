...
#ifndef LV_ATTRIBUTE_PREV
#define LV_ATTRIBUTE_PREV
#endif

static const
LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_PREV
uint8_t prev_map[] = {

    0x00,0x00,0x00,0x03,0x00,0x00,0x00,0xfc,
